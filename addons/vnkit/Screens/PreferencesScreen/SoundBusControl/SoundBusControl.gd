...
func _ready() -> void:
	...
	if bus_name in VNKit.audio_buses:
		mute = bool(VNKit.audio_buses[bus_name].mute)
	...
	if bus_name in VNKit.audio_buses:
		volume = float(VNKit.audio_buses[bus_name].volume)
...
func _on_visibility_changed() -> void:
	...
	$VBox/CheckButton.pressed = !mute
	VNKit.audio_buses[bus_name] = {"mute":mute, "volume":volume}
